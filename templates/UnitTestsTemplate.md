...
|yes|yes|no|invalid|The employee should not be updated|testUpdateEmployeeMissingName|
|yes|no|yes|invalid|The employee should  not be updated|testUpdateEmployeeMissingSurname|
|yes|no|no|valid|The employee should be updated|testUpdateEmployeeWithSuccess|
...
|yes|no|Invalid|The employee should not be created|testCreateEmployeeMissingName|
|no|yes|Invalid|The employee should not be created|testCreateEmployeeMissingSurname|
